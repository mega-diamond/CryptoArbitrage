...
namespace CryptoArbitrageLibrary.Service.Caching
{
    ...
    {
        private readonly IBybit iBybit;
        private readonly IMemoryCache memoryCache;
        private const string memorykey = "Bybit";


        public Bybit(IBybit bybit, IMemoryCache memoryCache)
        {
            this.iBybit = bybit;
        ...
        public async Task<List<SymbolData>> GetSymbols()
        {
            ...
            symbols = await this.iBybit.GetSymbols();
            if (symbols != null)
                memoryCache.Set(
        ...
        public async Task<TradeRoot> GetTrades(SymbolData symbolData)
        {
            ...
            trade = await this.iBybit.GetTrades(symbolData);
            if (trade != null)
                memoryCache.Set(
